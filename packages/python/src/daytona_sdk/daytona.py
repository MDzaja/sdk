...
The Daytona module allows you to create, manage, and interact with Daytona workspaces.
...
class Daytona:
    ...
    def remove(self, workspace: Workspace) -> None:
        ...
        Args:
            workspace: The workspace instance to remove.
    ...
    def start(self, workspace: Workspace, timeout: Optional[float] = None) -> None:
        ...
        Args:
            ...
            timeout: Optional timeout in seconds to wait for the workspace to start. If set to 0, it will wait indefinitely.
