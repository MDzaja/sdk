...
Example:
    ...
    # Make some changes
    workspace.fs.write_file("/workspace/repo/test.txt", "Hello, World!")
...
Note:
    All paths used in this module should be absolute paths within the workspace.
    The workspace must be in a 'started' state before performing Git operations.
"""
...
class Git:
    ...
    def add(self, path: str, files: List[str]) -> None:
        ...
        Args:
            ...
            files (List[str]): List of file paths to stage, relative to the repository root.
