...
Example:
    ...
    # File operations
    workspace.fs.write_file("/workspace/test.txt", "Hello, World!")
    content = workspace.fs.read_file("/workspace/test.txt")
...
Note:
    ...
    Use wait_for_workspace_start() after creating or starting a workspace.
"""
