...
class Process:
    ...
    def exec(self, command: str, cwd: Optional[str] = None, timeout: Optional[int] = None) -> ExecuteResponse:
        ...
        This method executes a one shell command in the workspace.
        ...
        Args:
            ...
            timeout (Optional[int]): Maximum time in seconds to wait for the command
                to complete. If set to 0, it will wait until the command completes.
    ...
    def code_run(self, code: str) -> ExecuteResponse:
        ...
        This method executes code using the language runtime configured for the
        workspace.
